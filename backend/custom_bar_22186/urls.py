"""custom_bar_22186 URL Configuration
...
admin.site.site_header = "Custom Bar"
admin.site.site_title = "Custom Bar Admin Portal"
admin.site.index_title = "Custom Bar Admin"

# swagger
api_info = openapi.Info(
    title="Custom Bar API",
    default_version="v1",
    description="API documentation for Custom Bar App",
)
